...
class ProformaInvoiceRetrievalResponse extends Response {


    public function __construct($orderNumber = 123, int $status = 200, array $headers = [], $body = null, string $version = '1.1', ?string $reason = null)
    {
